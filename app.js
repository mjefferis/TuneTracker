...
var map = new mapboxgl.Map({
    ...
    center: [-75.0, 39.0],//latLng.split(','), // starting position
        ...
        database.ref().once('value', function (snapshot) {
            ...
            snapshot.forEach(function (childSnapshot) {
                ...
                var formattedData = {
                    "type": "Feature",
                    "properties": {
                        "description": "<table><tr><td><h1>" + name + "</h1></td></tr><tr><td>" + contact + "</td></tr><tr><td><div id='ytPlayer'> </div></td></tr><tr><td>" + desc + "</td</tr></table>",
                        "icon": "theatre"
                    },
                    "geometry": {
                        "type": "Point",
